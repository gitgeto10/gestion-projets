...
<div class="sidebar">
    <ul>
        ...
        <li><a href="/admin/profil" class="active"><i class="fas fa-user-circle"></i><span>Profile</span></a></li>
    </ul>
</div>
    ...
    <div class="profile-container">
        <div class="profile-header">
            <div class="profile-avatar">
                ${fn:toUpperCase(utilisateur.nom.substring(0,1))}
            </div>
            <div>
                <h1 class="profile-title">${utilisateur.nom}</h1>
                <div class="profile-role">${utilisateur.role}</div>
            </div>
        </div>
        ...
        <div class="profile-section">
            ...
            <div class="profile-grid">
                <div class="profile-field">
                    <span class="profile-label"><i class="fas fa-user"></i> Nom complet</span>
                ...
                <div class="profile-field">
                    <span class="profile-label"><i class="fas fa-user-tag"></i> Rôle</span>
