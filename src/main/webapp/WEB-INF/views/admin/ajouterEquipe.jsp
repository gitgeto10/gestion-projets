...
<div class="main-content">
    <div class="form-container">
        <h1><i class="fas fa-plus"></i> Ajouter une Équipe</h1>

        <form:form modelAttribute="equipe" method="post" action="${pageContext.request.contextPath}/admin/equipes/ajouter">
